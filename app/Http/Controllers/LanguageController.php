...
class LanguageController extends Controller
{
    public function index()
    {
        ...
        return view('admin.lang.index')->with($data);
    }
    ...
    public function transalate(Request $request)
    {
       ...
       return view('admin.lang.translate',compact('translators','languages'));
    }
    ...
    public function transalateUpate(Request $request)
    {
        ...
        return redirect()->route('language.translator',$request->lang)->with('success',__('Translation Updated Suceesfully'));
    }
