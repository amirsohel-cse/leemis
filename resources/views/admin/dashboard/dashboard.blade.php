                    ...
                    @if ($profit->isNotEmpty())
                        ...
                        <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                            <p class="text-muted mb-1">Total Amount After Withdraw Complete<span id="mini-bar-chart4"
                                    class="mini-bar-chart"></span></p>
                            <h5 class="mb-0">
                                {{ $order_o[0]->where('status', 'Completed')->sum('subtotal') - $data['withdraw']->where('status', 'Completed')->sum('amount') }}
                            </h5>
                        </div>
                        <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                                        ...
                                        <div class="carousel-inner">
                                            @if ($profit->isNotEmpty())
                                                <div class="carousel-item active">
                                                    <div>Total Sell</div>
                                                    <div class="mt-3 h1">
                                                        {{ $order_o[0]->where('status', 'Completed')->sum('subtotal') }}
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div>Total Product Sell</div>
                                                    <div class="mt-3 h1">
                                                        {{ $profit->where('status', 'Completed')->sum('qty') }}</div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div>Total Profit</div>
                                                    <div class="mt-3 h1">
                                                        {{ $profit->where('status', 'Completed')->sum('profit') }}</div>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="carousel-inner">
                                            @if ($profit->isNotEmpty())
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="mt-3 h1">
                                                        {{ $profit[0]->where('status', '=', 'Completed')->count() }}</div>

                                                </div>
                                                <div class="carousel-item">
                                                    <div>Order Pending</div>
                                                    <div class="mt-3 h1">
                                                        {{ $profit[0]->where('status', '=', 'Pending')->count() }}</div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div>Order Declined</div>
                                                    <div class="mt-3 h1">
                                                        {{ $profit[0]->where('status', '=', 'Declined')->count() }}</div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div>Total Number of Order</div>
                                                    <div class="mt-3 h1">{{ $profit[0]->count() }}</div>
                                    ...
                                    <div id="slider4" class="carousel vert slide" data-ride="carousel"
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <div class="mt-3 h1">
                                                    {{ $data['withdraw']->where('status', '=', 'Completed')->count() }}
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Withdraw Pending</div>
                                                <div class="mt-3 h1">
                                                    {{ $data['withdraw']->where('status', '=', 'Pending')->count() }}</div>
                                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card bg">
                            <div class="body">
                                ...
                                <h3 class="mb-1"> {{ $order_o[0]->where('status', 'Completed')->sum('subtotal') }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card bg">
                            <div class="body">
                                ...
                                <h3 class="mb-1"> {{ $profit->where('status', 'Completed')->sum('qty') }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card bg">
                            <div class="body">
                                ...
                                <h3 class="mb-1"> {{ $profit->where('status', 'Completed')->sum('profit') }}</h3>
                            </div>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card bg1">
                                <div class="body">
                                    ...
                                    <h3 class="mb-1">{{ $data['withdraw']->where('status', '=', 'Pending')->count() }}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card bg1">
                                <div class="body">
                                    ...
                                    <h3 class="mb-1">
                                        {{ $data['withdraw']->where('status', '=', 'Processing')->count() }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card bg1">
                                <div class="body">
                                    ...
                                    <h3 class="mb-1">{{ $data['withdraw']->where('status', '=', 'Completed')->count() }}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card bg1">
                                <div class="body">
                                    ...
                                    <h3 class="mb-1">{{ $data['withdraw']->where('status', '=', 'Declined')->count() }}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data['tsp'] as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->stock }}</td>
                                    <td><a href="{{ route('productView', $row->id) }}"
                                            class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer"
                                            type="button"> view </a></td>
                                </tr>
                            @endforeach
