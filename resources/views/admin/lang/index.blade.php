                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-md btn-primary edit mr-1"
                                            data-href="{{ route('language.edit', $lang) }}"
                                            data-lang="{{ $lang }}"><i class="fa fa-edit"></i></button>

                                        @if (!$lang->is_default)
                                            <button class="btn btn-md btn-danger delete mr-1"
                                                data-href="{{ route('language.delete', $lang) }}"><i
                                                    class="fa fa-trash"></i></button>
                                        @endif
                                        <a href="{{ route('language.translator', $lang->short_code) }}"
