...
@section('main-content')
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                ...
                                @php
                                    $attributeIds = collect($product->product_specification)
                                        ->pluck('category_attribute_id')
                                        ->toArray();
                                    
                                    $optionIds = collect($product->product_specification)
                                        ->pluck('attribute')
                                        ->toArray();
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        @foreach ($attr->options as $option)
                                                            <div class="col-md-4">
                                                                <label class="container">{{ $option->option }}
                                                                    <input type="hidden" value="{{ $attr->id }}"
                                                                        name="product_specification[{{ $option->id }}][category_attribute_id]">
                                                                    <input type="checkbox"
                                                                        name="product_specification[{{ $option->id }}][attribute]"
                                                                        value="{{ $option->id }}"
                                                                        @if (in_array($attr->id, $attributeIds) && in_array($option->id, $optionIds)) checked @endif>
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                            </div>

                                                            <div class="col-md-4">
                                                                <label for="">Qty <input type="number"
                                                                        class="form-control"
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="">Price <input type="number"
                                                                        class="form-control"
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <label for="basic-url"> <span style="font-size: 18px;margin-right:10px"><b>Feature
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="fetureInput"
                                                name="photo">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <label for="basic-url"> <span style="font-size: 18px;margin-right:10px;"><b>Product
                                                Gallery
                                        ...
                                        <div class="img-thumbs" id="img-preview">
                                            @foreach ($gallery as $data)
                                                <div class="wrapper-thumb">
                                                    <img src="{{ asset('uploads') }}/product-gallery/{{ $data->image_file }}"
                            ...
                            <div class="row my-5">
                                ...
                                {{-- <div class="fancy-checkbox mx-5">
                                    <label><input type="checkbox" id="checked"
                                            {{ $product->ship != null ? 'checked' : '' }} onclick="valueChanged()"><span
                                            style="font-size: 18px;"><strong>Allow Estimated Shipping
                                                Time</strong></span></label>
                                </div>


                                <div class="fancy-checkbox mx-5">
                                    <label><input type="checkbox" id="checked1" value="specification" name="specification"
                                            onclick="valueChanged1()"><span style="font-size: 18px;"><strong>Allow Product
                                                Sizes</strong></span></label>
                                </div>


                                <div class="fancy-checkbox ml-5">
                                    <label><input type="checkbox" id="checked2"
                                            {{ count(array_filter($product->color ?? [])) > 0 ? 'checked' : '' }}
                                            onclick="valueChanged2()"><span style="font-size: 18px;"><strong>Allow Product
                                                Colors</strong></span></label>
                                </div> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="number" min="0" step="0.01" class="form-control"
                                            placeholder="e.g 20" aria-label="Product Name"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <label for="basic-url"><span style="font-size: 18px;"><b>Product Stock</b></span>
                                        (Leave
                                        Empty
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="offer" id="" class="form-control">
                                        <option value="1" {{ $product->offer_product ? 'selected' : '' }}>Yes
                                        </option>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-5">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Enter Description" id="summernote" name="details" s>{!! $product->details !!}</textarea>
                                    </div>
                                    @error('details')
                                        <p class="form-text text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-lg-4 col-md-12 ">
                                    @if ($product->online_payment == 1)
                                        <label for="basic-url"><span style="font-size: 18px;"><b>Online Payment
                                                    Only</b></span></label>
                                        <div class="fancy-checkbox mt-3">
                                            <input type="hidden" name="online_payment" value="0">
                                            <label><input type="checkbox" name="online_payment" value="1"
                                                    checked><span>Check if only online payment is applicable</span></label>
                                        </div>
                                    @endif
                                    @if ($product->online_payment == 0)
                                        ...
                                        <div class="fancy-checkbox mt-3">
                                            <input type="hidden" name="online_payment" value="0">
                                            <label><input type="checkbox" name="online_payment"
                                                    value="1"><span>Check if
                                                    only online payment is applicable</span></label>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-lg-4 col-md-12 ">
                                    ...
                                    <label for="basic-url"><span style="font-size: 18px;"><b>Trending</b></span></label>
                                    <div class="fancy-checkbox mt-3">
                                        <input type="hidden" name="tranding" value="0">
                                        <label><input type="checkbox" name="tranding" value="1"
                                                @if ($product->trending) checked @endif><span>Trending
                                                Product</span></label>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-12 ">
                                    ...
                                    <label for="basic-url"><span style="font-size: 18px;"><b>Top Selling
                                                Product</b></span></label>
                                    <div class="fancy-checkbox mt-3">
                                        <input type="hidden" name="top" value="0">
                                        <label><input type="checkbox" name="top" value="1"
                                                @if ($product->top) checked @endif><span>Top Selling
                                                Product</span></label>
                                    </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <label for="basic-url"><span style="font-size: 18px;"><b>Tags</b></span> (Seperate
                                        with
                                        comma)</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
    ...
    <script>
        $(function() {
            let counter = "{{ count($product->product_specification ?? []) }}"
            $('#addSizeBtn').on('click', function() {
                $('#size_name').append(`
                    <input type="text" class="form-control" placeholder="Size Name"
                     aria-label="Product Name" aria-describedby="basic-addon1" name="product_specification[${counter}][size]" value=""><br>
                `);

                $('#size_qty').append(`
                    <input type="text" class="form-control" placeholder="Size Qty"
                         aria-label="Product Name" aria-describedby="basic-addon1"
                         name="product_specification[${counter}][size_qty]" value=""> <br>
                `);
                ...
                <div>
                    <input type="txt" min="0"  step="0.01" class="form-control"
                           ...
                           aria-describedby="basic-addon1" name="product_specification[${counter}][size_price]"> <br>
                </div>
                </div>
                <div class="col-md-3">
...
@push('scripts')
    <script>
        ...
        $('.categoryId').on('change', function() {
            ...
            getCategoryProductType($(this).val(), "{{ $product->id }}")
        })


        function getCategoryProductType(category_id, product_id) {

            $.ajax({
                type: "GET",
                url: "{{ route('get-category-product-type') }}",
                data: {
                            ...
                            <div class="d-flex flex-wrap align-items-center">  
                                <div class="col-md-4">
                                    <label class="container">${opt.options[index].option}
                                        ...
                                        <input type="checkbox" name="product_specification[${counter}][attribute]" ${response.optionId.includes(opt.options[index].id) ? 'checked' : ''} value="${opt.options[index].id}">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label for="">Qty <input type="number" class="form-control" name="product_specification[${counter}][qty_attr]" value="0"></label>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $('select[name="subcategory_id"]').append('<option value="0">' +
                                'Not Found' + '</option>');
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $.each(data, function(key, value) {
                                ...
                                console.log(value)
                                $('select[name="childcategory_id"]').append('<option value="' +
                                    value.id + '">' + value.name + '</option>');
                            });
                        } else {

                            $('select[name="childcategory_id"]').append('<option value="0">' +
                                'Not Found' + '</option>');
