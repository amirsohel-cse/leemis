                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse($sliders as $row)
                                <tr data-id="{{$row->id}}">
                                    <td style="width:100px height:100px"><img src="\storage\subcategorysliderstore\{{$row->photo}}" alt="image" style="width:100%" height="200px"></td>
                                    <td>{{$row->subcategory->name}}</td> 
                                    <td>
                                        <button data-slider="{{$row}}" data-image="\storage\subcategorysliderstore\{{$row->photo}}" data-url="{{route('subcategoryslider.update', $row->id)}}" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"><i class="fa fa-edit"></i> Edit</button>
                                        <a href="{{route('subcategoryslider.delete', $row->id)}}" class="btn btn-danger btn-round deleteBtn" style="cursor: pointer" type="submit"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @empty
    ...
    <script>
        $(function(){
            $('.editBtn').on('click', function(){
                ...
                modal.find('#categoryId_edit').val($(this).data('slider').subcategory_id)
