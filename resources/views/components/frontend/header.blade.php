        ...
        <div class="header-container-fluid d-flex align-items-center">
            <div class="header-left">
                ...
                <a href="/" class="logo ml-lg-0">
                    ...
                    ?>
                    @if ($headerLogo)
                        <img src="\storage\storeLogo\{{ $headerLogo->file }}" alt="logo" width="110"
                            height="30" />
                    @else
            ...
            <div class="header-right">
                ...
                @endphp
                <select class="header-location changeLang">
                ...
                @guest
                    <a class="d-lg-show login compare label-down link d-xs-show ml-4 header-middle-btn" data-toggle="modal"
                        href="#LoginModal">
                        <span class="caption">{{ __('Sign In') }}</span>
                ...
                <div style="position:relative;" class=" cart-dropdown cart-offcanvas mr-0 mr-lg-2 d-flex">
                    ...
                    <!--    href="{{ Auth::id() ? route('wishlist.view', Auth::id()) : '#' }}">-->
                    ...
                    <a id="cart" href="#"
                        ...
                        <span class="caption">{{ __('Cart') }}</span>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="locationModalLabel">{{__('Add New Address')}}</h5>
                ...
                <div class="modal-footer">
                    <form action="{{ route('save-my-place') }}" method="post">
                        @csrf
                        <input type="hidden" name="address" id="form_address"
                            value="{{ auth()->check() ? auth()->user()->my_place : '' }}">
                        <button type="submit" class="btn btn-primary" id="disabtn">{{__('Save changes')}}</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="header-bottom sticky-content fix-top sticky-header has-dropdown">
        <div class="header-container-fluid">
            <div class="inner-wrap">
                                ...
                                @forelse($categories as $category)
                                    ...
                                    <li class="has-submenu">
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <h4 class="menu-title">{{ __('Top Brand') }}</h4>
                                                <hr class="divider">
                                                <ul>
                                                    @forelse($category->sub_categories as $subCategory)
                                                        <li>
                                                            <a
                                                                href="{{ route('brand.product', [$subCategory->top_brand, Str::slug($subCategory->topBrand->name)]) }}">{{ @$subCategory->topBrand->name }}</a>
                                                        </li>
                                                    @empty
                                                    @endforelse
                    ...
                    <nav class="main-nav">
                        <ul class="menu active-underline">
                            ...
                            @forelse ($top as $item)
                                <li class="has-mega-menu has-submenu">
                                    <a class="text-decoration-none"
                                        href="{{ url($item->url) }}">{{ __($item->name) }}</a>


                                    <div class="megamenu p-4">
                                        <div class="row g-3">
                                            <div class="col-lg-2">
                                                <h4 class="menu-title">{{ __('CATEGORIES') }}</h4>
                                                <ul>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row g-3">
                                                    ...
                                                    @foreach ($item->menuBrands as $brand)
                                                        <div class="col-lg-4 mb-3">
                                                            <div class="header-brand">
                                                                <a
                                                                    href="{{ route('brand.product', [$brand->brand->id, Str::slug($brand->brand->name)]) }}">
                                                                    <img src="{{ asset('uploads/brand-images/' . $brand->brand->photo) }}"
                                                                        alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row h-100">
                                                    @if ($item->images != null)
                                                        @foreach ($item->images as $image)
                                                            <div
                                                                class="@if ($loop->first) col-lg-7 @else col-md-5 @endif">
                                                                <div class="header-menu-right-promo">
                                                                    <img src="{{ asset('uploads/top_menu_images/' . $image) }}"
                                                                        alt="image">
                                                                </div>
                                                            </div>
                                                        @endforeach
                            ...
                            @empty
                                <p>{{ __('Not found') }}</p>
                            @endforelse
                            <li><a href="{{ url('allshop') }}">{{__('All Shop')}}</a></li>
                            <li><a href="{{ route('vendor.login') }}" class="sell-on-btn"><i class="fas fa-bolt"></i> {{__('Sell on HyperShop')}}</a></li>
                        </ul>
                    </nav>
                ...
                <!-- <div class="header-right">
                                <a  class=" text-decoration-none"  href="{{ route('blogslist') }}"></i>{{ __('News Feed') }}</a>
                                <a  class=" text-decoration-none mr-5" data-toggle="modal" href="#TrackModal"></i>{{ __('Track Order') }}</a>
                                <a target="_blank" href="{{ route('vendor.login') }}" class="mr-4 text-decoration-none"></i>{{ __('Merchant Zone') }}</a>
                            </div> -->
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="container">
                    <h1 class="page-title mb-0">{{ __('Login') }}</h1>
                </div>
                            ...
                            <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                                        ...
                                        <form id="customerLogin" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="alert alert-danger alert-dismissible d-none"
                                                    ...
                                                    <strong>{{ __('Your Account Has Been Disabled') }}!</strong>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="password-field">
                                                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Minumum 8 characters" value="{{ old('password') }}" required autocomplete="password" autofocus>
                                            ...
                                            <a href="#" style="color:#fd3d11" class="fp mt-2">
                                                <u>{{ __('Forgot password') }}?</u> </a>

                                            <a href="#" id="login" type="submit"
                                                class="btn btn-primary my-4">{{__('Sign In')}}</a>

                                            <span class="font-size-md">
                                                {{ __('Don\'t have an account') }}? </span> <a style="color:#fd3d11;"
                                                class="mb-4  font-size-md"
                                                href="{{ route('customer.register') }}"><u>{{ __('Sign up') }}</u></a>
                                ...
                                <div class="social-icons social-icon-border-color d-flex justify-content-start">
                                    <a href="/login/facebook" class="social-button" id="facebook-connect">
                                        <span>{{ __('Sign In with Facebook') }}</span></a>
                                    <a href="/login/google" class="social-button" id="google-connect">
                                        <span>{{ __('Sign In with Google') }}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" style="margin-top: 50px;" id="otp-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content m-auto" id="modal-content" style="width: 50%">
            <div class="modal-header">
                <p class="modal-title" id="exampleModalLabel">{{__('Phone Verification')}}</p>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body m-0">
                ...
                <button type="button" id="verify" class="btn btn-primary mt-2">{{ __('Verify') }}</button>
                <button type="button" id="fp_verify" class="btn btn-primary mt-2">{{ __('Verify') }}</button>
                <button type="button" id="resend" class="btn btn-primary mt-2" disabled>{{__('Resend code')}}</button>
                <button type="button" id="fp_resend" class="btn btn-primary mt-2" disabled>{{ __('Resend code') }}
        ...
        <div class="modal-content m-auto" id="" style="width: 50%">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">
                    {{ __('Give phone no to get verification code') }}</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body m-0">
                ...
                <form id="fp-form" method="post">
                    ...
                    <input style="border-color:#fd3d11;" name="phone" id="fp-phone" placeholder="Mobile No."
                        type="number" class="form-control" value="{{ old('phone') }}" required
                    ...
                    <div class="mt-2">
                        ...
                        <div class="bottom login-toggle-btn">
                            <span class="helper-text mt-3">{{ __('Know your password') }}? <a id="fp_login_btn"
                                    style="float:none " href="#"> <u>{{ __('Login') }}
                                    </u></a></span>
                        </div>
                    </div>
                </form>
...
<div class="modal fade " id="reset-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content m-auto" id="" style="width: 50%">
            <div class="modal-header">
                <p class="modal-title" id="exampleModalLabel"> {{ __('Password Reset') }}</p>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body m-0">
                ...
                <form id="reset-form" method="post">
                    ...
                    <div class="">
                        <input id="reset_password" class="form-control" type="password" name="password"
                            placeholder="Password (minimum 8 characters)" value="{{ old('password') }}" required
...
<div style="margin-top:50px;" class="modal fade " id="TrackModal" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content m-auto" id="">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">{{__('Track Order')}}</h4>
            ...
            <div class="modal-body">
                ...
                <form id="track_form" method="post">
                    ...
                    <div class="mt-2">
                        <button class="btn-block btn-primary" type="submit">{{ __('Track Order') }}</button>
                    </div>
                </form>
