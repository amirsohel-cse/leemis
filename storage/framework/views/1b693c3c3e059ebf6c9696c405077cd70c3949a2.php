                        ...
                        <div class="account-wrapper">
                            <div class="left"
                                ...
                                <div class="account-content">
                                    <h3 class="account-title"><?php echo e(languageChange('Create your Account')); ?></h3>
                                    <p><span class="font-size-md"> Already have an account? </span> <a
                                            class="mb-4 text-primary font-size-md" href="<?php echo e(route('customer.login')); ?>">
                                            Login </a></p>
                                </div>
                            </div>
                                ...
                                <form method="post" id="registerForm">
                                    <div class="form-group mb-3">
                                        ...
                                        <input placeholder="Enter your name" id="reg_name" type="text"
                                            class="form-control" name="name" value="<?php echo e(old('name')); ?>" required>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="password-field">
                                            <input type="password" id="reg_password" class="form-control" name="password"
                                                value="<?php echo e(old('password')); ?>" placeholder="Minimum 8 characters" required>
                                    ...
                                    <div class="tacbox bg-transparent">
                                        ...
                                        <label for="checkbox"> I agree to these <a href="<?php echo e(route('pages', 'terms-of-use')); ?>">Terms and
                                                Conditions</a>.</label>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/auth/register.blade.php ENDPATH**/ ?>