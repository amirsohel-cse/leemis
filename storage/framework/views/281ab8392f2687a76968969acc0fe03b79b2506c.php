                ...
                <ul class="mobile-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('categorize.product',[$category->id, Str::slug($category->name)])); ?>">
                            <i class="w-icon-category"></i><?php echo e($category->getTranslation('name')); ?>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('subCategorize.product', [$subCategory->id, Str::slug($subCategory->name)])); ?>"><?php echo e($subCategory->getTranslation('name')); ?></a>
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('childCategorize.product', [$childCategory->id,Str::slug($childCategory->name)])); ?>">
                                            <?php echo e($childCategory->getTranslation('name')); ?></a>
                                    </li>
...
<?php /**PATH D:\My Workspace\Web\Laravel\Work\leemis\resources\views/components/frontend/mobile-menu.blade.php ENDPATH**/ ?>