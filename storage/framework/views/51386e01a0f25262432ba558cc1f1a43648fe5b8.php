        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    ...
                    <button class="btn btn-success btn-round float-right" id="addProductBtn" data-toggle="modal"
                        data-target="#addLangProductModal"><i class="fa fa-plus"></i> Add Translation</button>
                </div>
                <div class="body">
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Workspace\Web\Laravel\Work\leemis\resources\views/admin/product/product-translation.blade.php ENDPATH**/ ?>