                    ...
                    <table style="table-layout:fixed; width:100%;">
                        <tbody>
                            <tr class="border">
                                ...
                                <td class="p-2"><img src="<?php echo e(url($product->photo)); ?>"
                            ...
                            <tr class="border p-2">
                                ...
                                <td class="p-2">:</td>
                                <td class="p-2">
                                    <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><img class="img-fluid"
                                            src="<?php echo e(asset('uploads')); ?>/product-gallery/<?php echo e($data->image_file); ?>"
                                            id="fetureInputGallery" style="height: 80px;width: 100px;">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                            </tr>
                            <tr class="border">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Workspace\Web\Laravel\Work\leemis\resources\views/admin/product/viewProduct.blade.php ENDPATH**/ ?>