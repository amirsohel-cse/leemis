                                    ...
                                    <label for="basic-url"><span style="font-size: 18px;"><strong>Product
                                     ...
                                     <div class="form-floating">
                                        <textarea class="form-control" placeholder="Enter Description"
                                            id="summernote" name="details"><?php echo e(old('details')); ?></textarea>
                                    </div>
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/vendor/product/addProduct.blade.php ENDPATH**/ ?>