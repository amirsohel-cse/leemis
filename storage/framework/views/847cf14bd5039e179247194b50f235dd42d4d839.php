...
<script type="text/javascript">
    $(document).ready(function(){
        $( ".addFooter" ).submit(function( event ) {
            ...
            let email_support = $(this).find("input[name=email_support]").val();
            let help_center = $(this).find("input[name=help_center]").val();
            let delivery_time = $(this).find("input[name=delivery_time]").val();

            formData.append('footer', footer);
            formData.append('copyright', copyright);
            formData.append('copy', copy);
            formData.append('phone', phone);
            formData.append('email_support', email_support);
            formData.append('help_center', help_center);
