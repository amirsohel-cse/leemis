        ...
        <div class="card">
            ...
            <div class="body">
               <form class="addtext" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" id="headerText" name="file"  placeholder="Header Right" value="<?php echo e($right2); ?>" required>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/setting/headerText.blade.php ENDPATH**/ ?>