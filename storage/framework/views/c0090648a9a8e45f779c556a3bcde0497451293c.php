    ...
    <div class="block-header">
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <h1><strong>Sub-Category Translations</strong></h1>
                <span>Dashboard</span> <i class="fa fa-angle-right"></i>
                <span>Sub-Categories</span> <i class="fa fa-angle-right"></i>
...
<?php $__env->startSection('page-scripts'); ?>
    ...
    <script>
        $(".add-btn-submit").click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('admin.addSubCategoryTranslation')); ?>",
                data: {
        ...
        $(".edit-btn-submit").click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('admin.editSubCategoryTranslation')); ?>",
                data: {
                    category_id: category_id,
        ...
        $(".deleteBtn").click(function(e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('admin.deleteSubCategoryTranslation')); ?>",
                        data: {
                            translation_id: translation_id
                        },
                        success: function(data) {
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Workspace\Web\Laravel\Work\leemis\resources\views/admin/sub-category/sub-category-translation.blade.php ENDPATH**/ ?>