                                                        ...
                                                        <?php $__currentLoopData = $attr->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="col-md-4">
                                                                <label class="container"><?php echo e($option->option); ?>
                                                                    ...
                                                                    <input type="hidden" value="<?php echo e($attr->id); ?>"
                                                                        name="product_specification[<?php echo e($option->id); ?>][category_attribute_id]">
                                                                    <input type="checkbox"
                                                                        name="product_specification[<?php echo e($option->id); ?>][attribute]"
                                                                        value="<?php echo e($option->id); ?>"
                                                                        <?php if(in_array($attr->id, $attributeIds) && in_array($option->id, $optionIds)): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="img-thumbs" id="img-preview">
                                            <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="wrapper-thumb">
                                                    <img src="<?php echo e(asset('uploads')); ?>/product-gallery/<?php echo e($data->image_file); ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="offer" id="" class="form-control">
                                        <option value="1" <?php echo e($product->offer_product ? 'selected' : ''); ?>>Yes
                                        </option>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-5">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Enter Description" id="summernote" name="details" s><?php echo $product->details; ?></textarea>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-12 ">
                                    ...
                                    <div class="fancy-checkbox mt-3">
                                        ...
                                        <label><input type="checkbox" name="tranding" value="1"
                                                <?php if($product->trending): ?> checked <?php endif; ?>><span>Trending
                                                Product</span></label>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-12 ">
                                    ...
                                    <div class="fancy-checkbox mt-3">
                                        ...
                                        <label><input type="checkbox" name="top" value="1"
                                                <?php if($product->top): ?> checked <?php endif; ?>><span>Top Selling
                                                Product</span></label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        $(function() {
            let counter = "<?php echo e(count($product->product_specification ?? [])); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        $('.categoryId').on('change', function() {
            ...
            getCategoryProductType($(this).val(), "<?php echo e($product->id); ?>")
        })
        ...
        function getCategoryProductType(category_id, product_id) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('get-category-product-type')); ?>",
                data: {
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Workspace\Web\Laravel\Work\leemis\resources\views/admin/product/editProduct.blade.php ENDPATH**/ ?>