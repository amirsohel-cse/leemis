                            ...
                            <div class="row">
                                    ...
                                    <div class="product-gallery product-gallery-sticky">
                                        <div
                                            ...
                                            <figure class="product-image">
                                                <img src="<?php echo e("/$item->photo"); ?>" style="width: 100%; height: 500px"
                                            ...
                                            <?php $__empty_2 = true; $__currentLoopData = $item->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <figure class="product-image">
                                                    <img src="<?php echo e(asset('../../uploads/product-gallery/' . $row->image_file)); ?>"
                                        ...
                                        <div class="product-thumbs-wrap">
                                            <div class="product-thumbs row cols-4 gutter-sm">
                                                <div class="product-thumb active">
                                                    <img src="<?php echo e("/$item->photo"); ?>" alt="Product Thumb" width="400"
                                                        height="500">
                                                </div>
                                                <?php $__empty_2 = true; $__currentLoopData = $item->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                ...
                                <div class="col-md-4 mb-6 mb-md-8">
                                    <div class="product-details pt-5 pb-md-5 single-product-details"
                                        ...
                                        <div class="product-bm-wrapper">
                                            <figure class="brand">
                                                <?php if(isset($item->brand->photo)): ?>
                                                    <img src="<?php echo e(isset($item->brand->photo) ? '/uploads/brand-images/' . $item->brand->photo : ''); ?>"
                                            ...
                                            <div class="product-meta">
                                                <div class="product-categories font-weight-bold" style="font-size:15px">
                                                    ...
                                                    <span class="product-category newcustomcolor"><a
                                                            href="<?php echo e(route('categorize.product', [$item->categories->id, Str::slug($item->categories->name)])); ?>"><?php echo e(isset($item->categories->name) ? $item->categories->name : ''); ?></a></span>
                                                </div>
                                                ...
                                                <div class="product-sku mt-2 font-weight-bolder newcustomcolor"
                                                    style="font-size:15px">
                                                    Stock: <span id="stock"
                                                        data-stock="<?php echo e($item->stock); ?>"><?php echo e($item->stock); ?></span>
                                                </div>

                                                <div class="product-sku mt-2 font-weight-bolder" style="font-size:15px">
                                                    Estimate Shipping Time: <?php echo e($item->ship); ?></span>
                                                </div>
                                        ...
                                        <?php if($item->product_specification != null): ?>
                                            <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="product-form product-variation-form product-size-swatch">
                                                    <label class="mb-1"><?php echo e($attribute->name); ?>:</label>
                                                    <div class="flex-wrap d-flex align-items-center product-variations"
                                                        data-specification="<?php echo e($attribute->id); ?>">
                                                        <?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($spec['attribute'] != null): ?>
                                                                <a href="#" data-id="<?php echo e($item->id); ?>"
                                                                    data-price="<?php echo e($spec['price_attr']); ?>"
                                                                    data-qty="<?php echo e($spec['qty_attr']); ?>"
                                                                    data-specification="<?php echo e($attribute->id); ?>"
                                                                    class="size varient"
                                                                    data-option="<?php echo e($options->id); ?>"><?php echo e($options->option); ?></a>
                                                            <?php endif; ?>
                                            ...
                                            <div class="product-form container">
                                                ...
                                                <?php if($item->stock > 0): ?>
                                                    <button data-id="<?php echo e($item->id); ?>"
                                                        ...
                                                        <span> <?php echo e('Buy Now'); ?></span>
                                                    </button>
                                                    <button data-id="<?php echo e($item->id); ?>"
                                                        data-stock="<?php echo e($item->stock); ?>"
                                                        class="btn btn-primary btn-cart">
                                                        <i class="fas fa-shopping-cart"></i>
                                                        <span><?php echo e(languageChange('Add to Cart')); ?></span>
                                                    </button>
                                                <?php else: ?>
                                                    <button data-id="<?php echo e($item->id); ?>"
                                                        data-stock="<?php echo e($item->stock); ?>" class="btn btn-danger btn-cart"
                                                        disabled>
                                                        <i class="w-icon-cart"></i>
                                    ...
                                    <div class="widget widget-icon-box mb-6 product-details-widget">
                                        <div class="icon-box icon-box-side text-dark">
                                            ...
                                            <div class="icon-box-content">
                                                ...
                                                <p class="text-default"><?php echo e($left1); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="icon-box icon-box-side text-dark">
                                            ...
                                            <div class="icon-box-content">
                                                ...
                                                <p class="text-default"><?php echo e($left2); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="icon-box icon-box-side text-dark">
                                            ...
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title font-weight-bolder ls-normal">
                                                    Customer support</h4>
                                                <p class="text-default"><?php echo e($right); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="icon-box icon-box-side text-dark">
                                            ...
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title font-weight-bolder ls-normal">
                                                    Delivery</h4>
                                                <p class="text-default"><?php echo e($right2); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="banner banner-video product-video br-xs">
                                                    <figure class="banner-media video-container">
                                                        <?php if(!empty($item->youtube)): ?>
                                                            <iframe
                                                                src="https://www.youtube.com/embed/<?php echo e($item->youtube); ?>"
                                    ...
                                    <div class="tab-pane" id="product-tab-vendor">
                                        <div class="tab-vendor mt-4">
                                            <div class="left">
                                                <img src="<?php echo e(isset($item->vendor->shop_image) ? asset('/uploads/vendors/' . $item->vendor->shop_image) : ''); ?>"
                                                ...
                                                <ul class="vendor-info list-style-none">
                                                    <li class="store-name">
                                                        <h3 style="line-height:0" class="detail">
                                                            <?php echo e($item->vendor->shop_name); ?></h3>
                                                    </li>
                                                ...
                                                <div class="ratings-wrapper">
                                                    <div class="avg-rating-container">
                                                        ...
                                                        <div class="avg-rating">
                                                            ...
                                                            <div class="ratings-container">
                                                                <a href="#"
                                                                    class="rating-reviews">(<?php echo e(count($item->ratings)); ?>
                                                ...
                                                <?php if(Auth::check()): ?>
                                                    <div class="review-form-wrapper">
                                                        ...
                                                        <p class="mb-3">Your email address will not be published.
                                                            Required
                                                            fields are marked *</p>
                                                        <form action="<?php echo e(route('productrating')); ?>" method="POST"
                                                            class="review-form">
                                                            <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="comment-body">
                                                                    <div class="comment-content">
                                                                        <h4 class="comment-author">
                                                                            <h5 class="text-info"><?php echo e($r->name); ?>
        ...
        <section class="related-product-section py-5">
            <div class="container">
                <div class="title-link-wrapper mb-4">
                    ...
                    <a href="<?php echo e(isset($productDetails[0]->categories->id) ? route('categorize.product', [$productDetails[0]->categories->id, Str::slug($productDetails[0]->categories->name)]) : '#'); ?>"
                                                        ...
                                                        <div class="sticky-sidebar">
                                                            <div class="widget widget-icon-box mb-6">
                                                                ...
                                                                <div class="icon-box icon-box-side text-dark">
                                                                    ...
                                                                    <div class="icon-box-content">
                                                                        <h4 class="icon-box-title font-weight-bolder ls-normal">
                                                                            <?php echo e(isset($services[1]) ? $services[1]->title : 'Not Found'); ?></h4>
                                                                ...
                                                                <div class="icon-box icon-box-side text-dark">
                                                                    ...
                                                                    <div class="icon-box-content">
                                                                        <h4 class="icon-box-title font-weight-bolder ls-normal">
                                                                            <?php echo e(isset($services[2]) ? $services[2]->title : 'Not Found'); ?></h4>
                                                                ...
                                                                <div class="icon-box icon-box-side text-dark">
                                                                    ...
                                                                    <div class="icon-box-content">
                                                                        <h4 class="icon-box-title font-weight-bolder ls-normal">
                                                                            <?php echo e(isset($services[3]) ? $services[3]->title : 'Not Found'); ?></h4>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clients-project\hypershop_final\resources\views/frontend/product/product_details.blade.php ENDPATH**/ ?>