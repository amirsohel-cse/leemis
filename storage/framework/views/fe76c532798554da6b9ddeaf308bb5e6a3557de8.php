                            ...
                            <div class="right">
                                ...
                                <form id="customer-login-form" action="<?php echo e(route('customer.login')); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="font-weight-bold text-dark"><?php echo e(languageChange('Mobile no')); ?>.
                                            *</label>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/auth/login.blade.php ENDPATH**/ ?>