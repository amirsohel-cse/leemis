                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label><?php echo e(trans('Add product')); ?> *</label>
                                    ...
                                    <div class="form-group mt-2">
                                        <strong><?php echo e(trans('Print')); ?>: </strong>&nbsp;
                                        <strong><input type="checkbox" name="name" checked />
                                            <?php echo e(trans('Product Name')); ?></strong>&nbsp;
                                        <strong><input type="checkbox" name="price" checked />
                                            <?php echo e(trans('Price')); ?></strong>&nbsp;
                                        <!--<strong><input type="checkbox" name="promo_price"/> <?php echo e(trans('Promotional Price')); ?></strong>-->
                                    </div>
                                    <!--<div class="row">-->
                                    <!--    <div class="col-md-4">-->
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $("#submit-button").on("click", function(event) {
            ...
            var image = "<?php echo e(asset('storage/storeLogo/' . \App\Model\Logo::where('type', 'header')->first()->file)); ?>"
            ...
            $.ajax({
                url: "<?php echo e(route('product.print.barcode')); ?>",
                method: "GET",
                data: {
                    html: htmltext
                },
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/product/print_barcode.blade.php ENDPATH**/ ?>